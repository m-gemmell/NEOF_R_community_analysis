...
There is a [Iterative rarefaction book](https://neof-workshops.github.io/R_community_whqkt8/iterative_rarefaction).
...
Of course there is a lot of literature you can explore to inform your future analysis decisions. Below is a list of some importnat litertaure.
...
To create the mamba environment `kraken_biom` run the below commands in your bash. You will need to have installed `mamba` first.
