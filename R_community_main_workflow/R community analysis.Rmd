...
Prior to any coding, we will create a new directory for this workshop and create a new notebook called __"01-Import.ipynb"__ in it. We will be creating a new notebook for each chapter and numbering them so we can easily see the order of scripts.
...
Next step is to create a new R notebook, rename it to __"01-Import"__, and save it. Then we can carry on.
